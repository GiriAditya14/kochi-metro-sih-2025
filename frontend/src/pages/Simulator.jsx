    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">AI-powered simulation for passenger handling & energy optimization</p>
        </div>
      </div>
      ...
      <div className="flex gap-2 p-1 bg-slate-800/50 rounded-xl border border-slate-700/50">
        {[
          { id: 'passenger', label: 'Passenger Handling', icon: Users },
          { id: 'energy', label: 'Energy Optimization', icon: Zap },
          { id: 'combined', label: 'Combined Analysis', icon: Activity }
        ].map(tab => (
          <button
            key={tab.id}
            ...
            <div className="card-body space-y-4">
              {activeTab === 'passenger' && (
                <>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">
                      Duration: <span className="text-blue-400">{passengerParams.simulation_duration_minutes} min</span>
                    </label>
                    <input 
                      type="range" 
                      className="w-full accent-blue-500"
              ...
              {activeTab === 'energy' && (
                <>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">
                      Passenger Load: <span className="text-amber-400">{energyParams.passenger_load_percent}%</span>
                    </label>
                    <input 
                      type="range" 
                      className="w-full accent-amber-500"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">Speed Profile</label>
                    <select 
                      className="input w-full"
              ...
              {activeTab === 'combined' && (
                <>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">
                      Crowd Multiplier: <span className="text-purple-400">{combinedParams.expected_crowd_multiplier.toFixed(1)}x</span>
                    </label>
                    <input 
                      type="range" 
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">
                      Trains: <span className="text-purple-400">{combinedParams.trains_in_service}</span>
                    </label>
                    <input 
                      type="range" 
                      className="w-full accent-purple-500"
            ...
            <div className="card">
              <div className="card-body flex flex-col items-center justify-center py-16">
                ...
                <p className="text-slate-400 text-center max-w-md">
                  Adjust the parameters on the left and click run to see AI-powered analysis of passenger handling and energy optimization.
                </p>
              </div>
            </div>
          )}
                          ...
                          {results.results.critical_stations.slice(0, 5).map((station, i) => (
                            <div key={i} className="flex items-center justify-between bg-slate-800/50 rounded-lg px-3 py-2">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-red-400 text-sm">+{station.excess_passengers} excess</span>
                              </div>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="bg-slate-800/50 rounded-lg p-3">
                            <div className="text-slate-400 text-sm">Recommended Trains</div>
                            <div className="text-2xl font-bold text-white">{results.results.recommendations.recommended_trains}</div>
                          </div>
                          {results.results.recommendations.additional_trains_needed > 0 && (
                            <div className="bg-amber-500/20 rounded-lg p-3">
                              <div className="text-amber-400 text-sm">Additional Needed</div>
                              <div className="text-2xl font-bold text-amber-400">+{results.results.recommendations.additional_trains_needed}</div>
                            </div>
                          )}
                        </div>
                      </div>
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="bg-slate-800/50 rounded-xl p-4">
                      <h4 className="text-white font-semibold mb-4">Energy Breakdown</h4>
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={i} className="flex items-center gap-4">
                            ...
                            <div className={`w-24 text-right text-sm font-medium ${item.negative ? 'text-emerald-400' : 'text-white'}`}>
